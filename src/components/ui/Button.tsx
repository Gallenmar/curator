...
const Button = ({
  ...
  const variantStyles = {
    ...
    outline: 'border border-gray-300 bg-transparent text-gray-700 hover:bg-gray-100 focus:ring-gray-500 disabled:text-gray-300 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700',
