...
const OwnerDashboard = () => {
  ...
  const handleSubmitReading = (data: { hotWater: number; coldWater: number }) => {
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <StatCard
                ...
                icon={<Droplet className="h-6 w-6 text-red-600 dark:text-red-400" />}
                variant="danger"
              />
              ...
              <StatCard
                ...
                icon={<Droplet className="h-6 w-6 text-blue-600 dark:text-blue-400" />}
                variant="primary"
              />
              ...
              <StatCard
                title="Apartment"
                value="Apt 101"
                icon={<Home className="h-6 w-6 text-purple-600 dark:text-purple-400" />}
                variant="secondary"
              />
...
const NotificationItem = ({ title, message, time, variant }: NotificationItemProps) => {
  const variantStyles = {
